...
2. **(Algorithmic Modeling & Image Processing):**:* Implements a pure, vectorized **Logistic Regression with Gradient Descent** from scratch. The model minimizes a Binary Cross-Entropy loss function iteratively using raw matrix dot products.
